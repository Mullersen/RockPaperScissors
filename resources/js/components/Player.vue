...
export default {
    ...
    mounted: function(){
        this.$root.$on('playerMove', this.showPlayerMove);
    ...
    methods: {
        draw: function(){
            var element = this.$refs["player-class"];
